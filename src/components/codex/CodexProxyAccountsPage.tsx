...
export function CodexProxyAccountsPage() {
  ...
  const { accounts, catalog, unified, unifiedErrorKey, reloadUnified, acceptUnified, goSection } = useCodexProxyWorkspace();
  return <div className="codex-proxy-manager-accounts">
    ...
    </div> : <CodexUnifiedProxyPanel totalAccounts={accounts.length} catalog={catalog} view={unified}
